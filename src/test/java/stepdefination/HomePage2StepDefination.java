...
public class HomePage2StepDefination {
	...
	public void user_hover_on(String arg1) throws Throwable {
		...
		h.hover();
		Thread.sleep(3000);
		 extent.logPass("hovered successfully");
	...
	public void user_navigated_to_next_page_and_popup_closed() throws Throwable {
		Thread.sleep(3000);
		h.closePopup();
		 extent.logPass("popup closed successfully");
	}
	...
	public void enter_quantity() throws Throwable {
		Thread.sleep(3000);
		h.addToCart();
		 extent.logPass("added to cart successfully");
		Thread.sleep(3000);
		h.quantity();
		 extent.logPass("selected quantity successfully");
	}
	...
	public void user_get_price_of_product() throws Throwable {
		Thread.sleep(3000);
		h.Price();
		 extent.logPass("price got successfully");
	}
	...
	public void user_clicks_on_Checkout() throws Throwable {
		Thread.sleep(3000);
		h.checkout();
		 extent.logPass("checkout successfully");
	}
