...
public class HomePage2 {
    ...
    public void clickOnLaptop() {
    	helper.explicitWaitOfvisibilityOfElementLocated(Home2Ui.text,50);
   ...
   public void checkout() {
	   helper.explicitWaitOfvisibilityOfElementLocated(Home2Ui.checkout, 50);
...
public void enterUsername(String arg1) {
	helper.explicitWaitOfvisibilityOfElementLocated(Home2Ui.email, 50);
